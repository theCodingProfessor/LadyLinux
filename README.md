...
- 🤖 **AI Companion (Lady Linux Persona)**: A locally running LLM that can explain, guide, and assist.  
...
Modern computing systems increasingly:
- Obscure how data is collected, stored, and shared
- Shift configuration behind abstract toggles
- Remove user agency in favor of convenience
- Discourage inspection, repair, and learning

Lady Linux exists to reverse those trends.

Its goals are to:
- Improve **data literacy**
- Restore **inspectability and agency**
- Make operating systems **teachable**
...
- **LLM as infrastructure, not product**  
  The LLM is local-first, permission-scoped, auditable, and reversible.

- **Human-in-the-loop by design**  
  No autonomous system changes without explicit approval pathways.

- **Minimal, inspectable base system**  
  Built on Linux fundamentals with deliberate avoidance of unnecessary bloat.
...
- Design constraints and scope definitions
...
- Students studying operating systems, security, HCI, or AI
- Educators seeking teachable system platforms
- Open-source contributors (technical and non-technical)
